...
- 💻 **Windows (.7z):**  
  [Download for Windows v1.0.5+1](https://github.com/omnitechphilippines/ember-quest/releases/download/v1.0.0%2B1/windows-release-v1.0.5%2B1.7z)

- 📱 **Android (.apk):**  
  [Download for Android v1.0.5+1](https://github.com/omnitechphilippines/ember-quest/releases/download/v1.0.0%2B1/app-release-v1.0.5%2B1.apk)

- 🌐 **Web build (.7z):**  
  [Download Web Build v1.0.5+1](https://github.com/omnitechphilippines/ember-quest/releases/download/v1.0.0%2B1/web-release-v1.0.5%2B1.7z)
