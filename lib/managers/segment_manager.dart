...
final List<List<Block>> segments = <List<Block>>[segment0, segment1, segment2, segment3, segment4];

final List<Block> segment0 = <Block>[
...
final List<Block> segment1 = <Block>[
  Block(Vector2(0, 0), GroundBlock),
  Block(Vector2(1, 0), GroundBlock),
...
final List<Block> segment2 = <Block>[
  Block(Vector2(0, 0), GroundBlock),
  Block(Vector2(1, 0), GroundBlock),
  Block(Vector2(2, 0), GroundBlock),
  Block(Vector2(3, 0), GroundBlock),
...
final List<Block> segment3 = <Block>[
  Block(Vector2(0, 0), GroundBlock),
  Block(Vector2(1, 0), GroundBlock),
...
final List<Block> segment4 = <Block>[
  Block(Vector2(0, 0), GroundBlock),
  Block(Vector2(1, 0), GroundBlock),
  Block(Vector2(2, 0), GroundBlock),
